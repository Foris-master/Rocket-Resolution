 ...
 */
class Priority extends \Priority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Priority' . "\0" . 'idpriority', '' . "\0" . 'Priority' . "\0" . 'name', '' . "\0" . 'Priority' . "\0" . 'value');
        }
    ...
    public function getIdpriority()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdpriority();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdpriority', array());

        return parent::getIdpriority();
    }
